...
// 't', 'u', 'v', 'w', 'x', 'y', 'z', '{', '|', '}', 155, 210));
// 	printf("\n--reg_printf--\n");
printf("\n1: %d\n", printf("*Kashim a %c histoires à raconterIl fait au moins %c %c c ly est fantastique!", 0, 0, 0));
printf("\n2: %d\n", ft_printf("*Kashim a %c histoires à raconterIl fait au moins %c %c c ly est fantastique!", 0, 0, 0));
return (0);
}
